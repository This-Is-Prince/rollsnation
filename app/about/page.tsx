...
import { Award, ArrowRight, Heart, TrendingUp } from 'lucide-react';

export const metadata: Metadata = {
    title: 'About Us | Rolls Nation - The Taste of Tradition',
    description: 'Discover the story behind Rolls Nation. From humble beginnings to a growing franchise, we are dedicated to serving the most authentic and delicious rolls in India.',
    openGraph: {
        title: 'About Rolls Nation',
        description: 'Our journey of passion, flavor, and authentic Indian street food.',
...
export default function AboutPage() {
    const teams = [
        {
            name: "Team Member",
            position: "Position",
            url: "/staff/staff-1.jpg"
        },
        {
            name: "Team Member",
            position: "Position",
            url: "/staff/staff-2.jpg"
        },
        {
            name: "Team Member",
            position: "Position",
            url: "/staff/staff-3.jpg"
        },
        {
            name: "Team Member",
            position: "Position",
            url: "/staff/staff-4.jpg"
        },
        {
            name: "Team Member",
            position: "Position",
            url: "/staff/staff-5.jpg"
        },
    ];
    ...
    return (
        ...
        <section className="relative h-[50vh] flex flex-col justify-center items-center bg-zinc-900 overflow-hidden border-b border-zinc-800">
        ...
        <section className="py-20 px-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-white uppercase">
                    From a Small Cart to a <span className="text-yellow-500">Nation</span>
                </h2>
                <div className="space-y-4 text-zinc-400 text-lg leading-relaxed">
                    ...
                    <p>
                    Today, we are proud to serve thousands of happy customers, maintaining the same love and quality that we put into our very first roll.
                    </p>
                </div>
                
                <div className="grid grid-cols-2 gap-6 pt-4">
                    <div className="bg-zinc-900 border border-zinc-800 p-4 rounded-xl">
                    <h4 className="text-3xl font-black text-white mb-1">75+</h4>
                    <p className="text-xs text-yellow-500 uppercase tracking-wider font-bold">Outlets</p>
                    </div>
                    <div className="bg-zinc-900 border border-zinc-800 p-4 rounded-xl">
                    <h4 className="text-3xl font-black text-white mb-1">100k+</h4>
                    <p className="text-xs text-yellow-500 uppercase tracking-wider font-bold">Happy Eaters</p>
                    </div>
                </div>
                </div>

                <div className="relative h-125 w-full bg-zinc-900 rounded-3xl overflow-hidden border border-zinc-800 group animate-in fade-in slide-in-from-right-8 duration-700 delay-100">
                    <Image 
                        src="/staff/founder.jpg"
        ...
        <section className="py-20 px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {teams.map((item, idx) => (
                <div key={item.url + idx} className="group">
                    <div className="relative h-80 bg-zinc-900 rounded-2xl mb-6 overflow-hidden border border-zinc-800">
                        <Image 
                            src={item.url}
                            alt="Rolls Nation Founder"
                            fill
